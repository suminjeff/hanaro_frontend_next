  ...
  return (
    <div className="flex justify-center items-center h-4/5">
      <form
        ...
        className="flex flex-col justify-center items-center w-full max-w-md p-6 space-y-6 bg-white shadow-lg rounded-lg"
      >
        ...
        <div className="w-full flex flex-col space-y-3">
          <button
            ...
            onClick={() => signIn("github", { callbackUrl: "/recipe" })}
          >
            Sign in with Github
          </button>
        </div>
